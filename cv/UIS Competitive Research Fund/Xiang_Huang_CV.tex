...
Algorithmic Information Theory, Analog Computing, Theoretical Foundations.
...
\end{outerlist}
\section{CSRG Proposal Related Journal Publications}
...
\section{CSRG Proposal Related Conference Publications}
\begin{etaremune}
  \item Xiang Huang and Rachel Huls. Computing Real Numbers with Large-Population Protocols Having a Continuum of Equilibria. The 28th International Conference on DNA Computing and Molecular Programming (DNA 28, Albuquerque, NM, Aug 8-12, 2022). (\textbf{paper published with UIS undergraduate})
