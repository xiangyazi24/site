...
\begin{etaremune}
    \item Xiang Huang, ``Deterministic Chemical Reaction Network,'' completed chapter for \textit{The Art of Molecular Programming}. Part of a grassroots community initiative to create a comprehensive molecular programming textbook (\href{https://molecularprogrammers.org/#aomp}{molecularprogrammers.org}).
\end{etaremune}
...
\section{Student Research Supervision}
