...
<p style="margin-left: 30px">I would require that you take CSC 499: Tutorial. (Some students can also do IPL (Internship) with me.) That is a way that you can earn credits while doing research with me. More importantly, it buys you some time. You can take it as an elective and it counts towards graduation (at least for undergraduates; for grads, I might need to offer it as CSC 599.).  You typically have to have my approval to be able to register the course.</p>
