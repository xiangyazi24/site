...
4. Basics of p-adic numbers and its applications.

5. [Manim](https://github.com/3b1b/manim) Visualization of some of the above topics.
...
3. Recursive functions and [Discrete ODEs](https://arxiv.org/abs/2209.12168)
